...
<body>
	...
	%>
		<div class="alert alert-success" role="alert">
		  GarageOwner Registered Successfully!
		</div>
	<%
		}else if(m.equalsIgnoreCase("failed")){
	%>
		<div class="alert alert-danger" role="alert">
		  GarageOwner Email ID Already Exist!
		</div>
	<%		
		}else if(m.equalsIgnoreCase("invalid")){
			%>
			<div class="alert alert-danger" role="alert">
			  GarageOwner Email ID or Password INVALID!
			</div>
		<%		
    	...
    	<div class="row">
    		...
    		<div class="col-sm p-3 my-4 border">
    			...
    			<form action="AddGarageOwner" method="post" enctype="multipart/form-data" >
		            ...
		            <div class="py-2">
		                <input name="sec_vill" class="form-control" type="text"   placeholder="Your Sector/Village" maxlength="80" required />
		            </div>
		            <div class="py-2">
		            ...
		            <div class="py-2">
		            	<lable>Please upload garage image</lable>
