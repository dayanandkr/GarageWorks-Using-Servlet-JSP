...
<head>
    ...
    <meta name="author" content="Dayanand and Manoj" />
...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-light sticky-top px-4">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <div>
                <a class="font-weight-bold" href="tel:9931378403"> <i class="fas fa-phone-alt"></i>9931378403</a>
            </div>
        </div>
    </nav>
    <header>
    ...
    <section class="c-staff">
        <div class="row">
            <div class="col-sm p-2" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                <img src="resource/machanic1.jpg" alt="">
                <h5>Raj Kapoor</h5>
                <p>Running Repairs Specailist</p>
            </div>
            <div class="col-sm p-2" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
                <img src="resource/machanic2.jpg" alt="">
                <h5>Kamlesh Kapoor</h5>
                <p>Accidental Repairs Specailist</p>
            </div>
            <div class="col-sm p-2" data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000">
                <img src="resource/machanic3.jpg" alt="">
                <h5>Shambhu Sharma</h5>
                <p>General Inspection Specailist</p>
            </div>
        </div>
    </section>
