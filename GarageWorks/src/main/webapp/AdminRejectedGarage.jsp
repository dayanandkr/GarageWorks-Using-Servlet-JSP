...
<body>
    ...
    <section class="container py-2">
    	<%
   		...
   		ArrayList<HashMap> allGarage=db.getGarageByStatus("rejected");
   		for(HashMap garageDetails:allGarage){
   			...
   			<div class="bg-light p-2 m-2">
   				...
   				<a class="btn btn-success btn-sm" href="ChangeStatusGarageOwner?email=<%= garageDetails.get("email")%>&status=accepted">Activate</a>
