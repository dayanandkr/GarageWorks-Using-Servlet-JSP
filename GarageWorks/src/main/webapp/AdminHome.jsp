...
<body>
    ...
    <section class="container py-2">
    	<%
   		...
   		ArrayList<HashMap> allGarage=db.getGarageByStatus("pending");
   		for(HashMap garageDetails:allGarage){
   			...
   			<div class="bg-light p-2 m-2">
   				...
   				<a class="btn btn-success btn-sm" href="ChangeStatusGarageOwner?email=<%= garageDetails.get("email")%>&status=accepted">Accept</a>
   				<a class="btn btn-danger btn-sm" href="ChangeStatusGarageOwner?email=<%= garageDetails.get("email")%>&status=rejected">Reject</a>
